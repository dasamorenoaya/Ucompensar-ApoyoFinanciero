...
import SuperDocCertificateEditor from './SuperDocCertificateEditor';
...
function CertificateModuleContent({ templates, backups, admin, adminPassword, onChanged }: Props) {
  ...
  if (selected) {
    ...
    return <SuperDocCertificateEditor template={selected} adminPassword={adminPassword} onBack={() => setSelected(null)} onChanged={onChanged} />;
  }
